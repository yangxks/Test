...
static int *
_int_echo_1 (int  *argp, struct svc_req *rqstp)
{
	return (int_echo_1_svc(*argp, rqstp));
}

static int *
_get_str_len_1 (char * *argp, struct svc_req *rqstp)
{
	return (get_str_len_1_svc(*argp, rqstp));
}
...
testprog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case int_echo:
		...
		local = (char *(*)(char *, struct svc_req *)) _int_echo_1;
		break;

	case get_str_len:
		_xdr_argument = (xdrproc_t) xdr_wrapstring;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) _get_str_len_1;
		break;
